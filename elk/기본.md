<img width="457" alt="image" src="https://github.com/user-attachments/assets/a4ef655f-ceb6-4963-9c85-e10cb41e07b5" />## [구성 환경] 
...
```
[2025-02-04T06:16:03.421+00:00][ERROR][elasticsearch-service] Unable to retrieve version information from Elasticsearch nodes. security_exception: [security_exception] Reason: unable to authenticate user [kibana_system] for REST request [/_nodes?filter_path=nodes.*.version%2Cnodes.*.http.publish_address%2Cnodes.*.ip]
```
